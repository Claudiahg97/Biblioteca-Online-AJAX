...
<body>
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="pasww">Contraseña antigua</label>
                <input type="password" id="pasww" name="pasww" placeholder="Dejar vacío si no deseas cambiarla">
                <small class="info">Si quieres cambiar la contraseña, indica la antigua</small>
            </div>
            <div class="form-group">
                <label for="pasww">Nueva contraseña</label>
                <input type="password" id="pasww" name="pasww" placeholder="Dejar vacío si no deseas cambiarla" onkeyup="showHint(this.value)">
                <small class="info">Solo completa este campo si deseas cambiar tu contraseña</small>
            </div>
            <div class="form-group">
                <label for="pasww">Repite la contraseña</label>
                <input type="password" id="pasww" name="pasww" placeholder="Dejar vacío si no deseas cambiarla" onkeyup="showHint(this.value)">
                <small class="info">Repite la nueva contraseña</small>
            </div>
